...
- [ROADMAP.md](ROADMAP.md): fases P00–P20 e estado da execução P07.
- [docs/README.md](docs/README.md): índice P00–P07, segurança, operações, ADRs e histórico anterior.
...
**DEFERRED:** fluxos P08+, coordenação financeira persistida/eventos P10, entrega P11, autenticação P12, analytics P13 e ambientes de produção até os respectivos gates. A sequência `GOV/MVP-*` e os documentos `LES-*-R01` continuam como histórico; a baseline atual P00–P20 prevalece quando divergir.
