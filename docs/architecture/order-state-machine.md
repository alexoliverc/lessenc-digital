...
**Status:** especificação COMPLETE; transições puras e testes implementados na [P07](p07-core-implementation.md), agora COMPLETE. Persistência financeira coordenada permanece adiada para fase posterior.
