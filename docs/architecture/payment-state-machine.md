...
**Status:** especificação COMPLETE; transições puras e testes implementados na [P07](p07-core-implementation.md), agora COMPLETE. Confirmação por provedor e persistência coordenada permanecem adiadas.
