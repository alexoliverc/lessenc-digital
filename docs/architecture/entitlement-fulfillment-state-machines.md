...
**Status:** especificação COMPLETE; invariantes puros de ativação/revogação de Entitlement implementados na [P07](p07-core-implementation.md), aguardando revisão técnica. Entrega, Fulfillment e políticas OPEN permanecem adiados.
